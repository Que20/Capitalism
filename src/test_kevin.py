...
b1 = cap_graph_Button(cap_Rect(26,200,247,59), cap_Rect(10,30,247,59), menu_start, menu_start, menu_start, start)
b1.init(event_mouse, event_key, display_list)
b1.visibility(True)

b2 = cap_graph_Button(cap_Rect(26,260,247,59), cap_Rect(10,30,247,59), menu_quit, menu_quit, menu_quit, quit)
b2.init(event_mouse, event_key, display_list)
b2.visibility(True)

b3 = cap_graph_Button(cap_Rect(26,320,247,59), cap_Rect(10,30,247,59), menu_about, menu_about, menu_about, about)
